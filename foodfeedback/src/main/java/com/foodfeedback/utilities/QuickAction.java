...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public void addActionItem(ActionItem action) {
		...
		TextView weightInfo 	= (TextView) container.findViewById(R.id.tv_weight);
		...
		if (title != null) {
			text.setText(title);
			text.setTextColor(container.getResources().getColor(R.color.White));
		} else {
			text.setVisibility(View.GONE);
		}
		
		String weightInfoText 	= action.getWeightInfo();
		if (weightInfoText != null) {
			weightInfo.setText(weightInfoText);
			weightInfo.setTextColor(container.getResources().getColor(R.color.White));
		} else {
	...
	public void show (View anchor) {
		...
		Rect anchorRect 	= new Rect(location[0], location[1], location[0] + 5, location[1] 
		                	+ 5);
...
//		int xPos 			= ((screenWidth - rootWidth) / 2 )+ 600;
//		int yPos	 		= anchorRect.top - (rootHeight * 3);

		int xPos 			= 		getActionItem(0).getxPosition()-rootWidth;
		int yPos	 		=		getActionItem(0).getyPosition()-rootHeight;
