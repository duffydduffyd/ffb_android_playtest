...
public class MessagesFromUserCacheManager {

	public static boolean saveObject(Context ctx, MessageList obj, String id) throws Exception {
	...
	public static MessageList getObject(Context ctx, String id) throws Exception {
